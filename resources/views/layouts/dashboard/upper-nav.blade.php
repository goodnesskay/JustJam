<div class="be-wrapper @yield('optional_class') be-fixed-sidebar">
        ...
        <div class="container-fluid">
            ...
            <div class="be-right-navbar">
                <ul class="nav navbar-nav navbar-right be-user-nav">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="{{ asset('dashboard/assets/img/avatar.png') }}" alt="Avatar"><span class="user-name">Túpac Amaru</span></a>
